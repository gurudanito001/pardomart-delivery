...
interface MessageIconSVGProps {
  width?: number;
  height?: number;
}

export const MessageIconSVG: React.FC<MessageIconSVGProps> = ({ width = 30, height = 30 }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 30 31" fill="none">
      <Rect y="0.5" width="30" height="30" rx="15" fill="#0085FF" />
      <Path
