    ...
    items: [
      {
        ...
        originalQuantity: 5,
        image:
          "https://api.builder.io/api/v1/image/assets/TEMP/f58c1a19122fda28da6d87adec8eeb3ad60c22d6?width=132",
        category: "Frozen",
        status: "edit",
      },
      {
          ...
          <View style={styles.tipCard}>
            <View style={styles.tipContent}>
              ...
              <Text style={styles.tipText}>
                These are items substitutions that are awaiting confirmation
                from customers
              </Text>
            </View>
          </View>
...
const SubstitutionCard = ({ item }: SubstitutionCardProps) => {
  ...
  const backgroundColor =
    item.status === "edit" ? "rgba(196, 61, 40, 0.20)" : colors.background;
        ...
        <View style={styles.itemDetails}>
          ...
          <View style={styles.itemPriceRow}>
            ...
            <View style={styles.quantityContainer}>
              ...
              <Text style={styles.originalQuantityValue}>
                {" "}
