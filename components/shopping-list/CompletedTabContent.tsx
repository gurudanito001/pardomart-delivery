    ...
    items: [
      {
        ...
        quantity: 5,
        image:
          "https://api.builder.io/api/v1/image/assets/TEMP/8ca46a868ac10a74a0da8c30074c452c3ddf4ae8?width=114",
    ...
    items: [
      {
        ...
        originalQuantity: 5,
        image:
          "https://api.builder.io/api/v1/image/assets/TEMP/a499a598d54a4cf8d3d1529a18284e4be924b977?width=132",
        category: "Grocery",
        status: "confirmed",
        replacementItem: {
          id: "c2b",
          ...
          quantity: 5,
          image:
            "https://api.builder.io/api/v1/image/assets/TEMP/956b78689861a4302e29d6a66aeec32819e9ff9e?width=112",
          category: "Grocery",
          status: "confirmed",
        },
      },
...
export default function CompletedTabContent({
  ...
  const handleProceedToBagging = () => {
    router.push("/orders/preview-page" as any);
    onProceedToBagging?.();
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          onPress={handleProceedToBagging}
        >
    ...
    <View style={styles.completedCard}>
      ...
      <View style={styles.itemContent}>
        ...
        <View style={styles.itemDetails}>
          <Text
            style={[styles.itemName, hasReplacement && styles.replacedItemName]}
          >
            {item.name}
          </Text>
          <View style={styles.itemPriceRow}>
            <Text
              style={[
                styles.itemPrice,
                hasReplacement && styles.replacedItemPrice,
              ]}
            >
            ...
            <View style={styles.quantityContainer}>
              <Text
                style={[
                  ...
                  hasReplacement && styles.replacedQuantityLabel,
                ]}
              >
                QTY
              </Text>
              <Text
                style={[
                  ...
                  hasReplacement && styles.replacedQuantityValue,
                ]}
              >
                {hasReplacement
                  ? ` ${item.quantity} of ${item.originalQuantity}`
                  : ` ${item.quantity}`}
              </Text>
            </View>
          </View>
      ...
      {hasReplacement && (
        <>
          ...
          <View style={styles.itemContent}>
            <View style={styles.itemImageContainer}>
              <Image
                source={{ uri: item.replacementItem!.image }}
            ...
            <View style={styles.itemDetails}>
              ...
              <View style={styles.itemPriceRow}>
                <Text style={styles.itemPrice}>
                  ${item.replacementItem!.price.toFixed(2)}
                </Text>
                <View style={styles.quantityContainer}>
                  <Text style={styles.quantityLabel}>QTY</Text>
                  <Text style={styles.quantityValue}>
                    {" "}
                    {item.replacementItem!.quantity}
                  </Text>
                </View>
              </View>
            </View>
