...
import PhoneOutlineSVG from '@/components/icons/PhoneOutlineSVG';
import { CartItem, OrderItem } from '@/api';
...
export default function FindingItemsScreen() {
  ...
  const pendingOrderItems = useMemo(() => {
    ...
    return items.filter((item: OrderItem) => item.status !== 'FOUND' && item.status !== 'REPLACED' && item.status !== 'NOT_FOUND');
  }, [order]);
  ...
  if (isLoading) {
    return (
      <View style={[styles.container, styles.centered, { backgroundColor: '#0085FF' }]}>
            ...
            <View style={styles.customerInfo}>
              ...
              <View style={styles.customerActions}>
                ...
                <TouchableOpacity style={styles.actionButton} onPress={handleCallCustomer}>
                  <PhoneOutlineSVG width={30} height={30} strokeColor="#0085FF" />
                </TouchableOpacity>
              </View>
            </View>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.bottomSection}>
          {!allItemsFound && !showQuantityInput ? (
            ...
            <TouchableOpacity style={styles.scanButton} onPress={handleVerifyPickup}>
