...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: '#0085FF' }]} edges={['top','left','right']}>
      <StatusBar barStyle={isScrolled ? "dark-content" : "light-content"} backgroundColor={isScrolled ? "#FFF" : "#0085FF"} />
      <View style={[
        styles.header, 
          ...
          <View style={styles.profileContent}>
            <View style={styles.profileImageContainer}>
              <View style={styles.profileImage}>
                <Image
                source={user.image ? { uri: user.image } : require("../../../assets/images/user profile.png")}
