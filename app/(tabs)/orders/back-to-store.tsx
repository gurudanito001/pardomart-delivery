...
const RouteTimeline = () => (
  <Svg width={34} height={173} viewBox="0 0 34 173" fill="none">
    ...
    />
    <Path
      d="M16.0959 151.097C16.5523 150.533 17.4132 150.533 17.8697 151.097L22.3948 156.696C22.9976 157.441 22.4668 158.553 21.5079 158.553H12.4576C11.4987 158.553 10.9679 157.441 11.5707 156.696L16.0959 151.097Z"
      fill="#0E0D26"
    />
    <Circle cx={17} cy={166} r={7} fill="#BBBBBB" />
  </Svg>
);
...
const RoutePathSVG = () => (
  ...
  >
    ...
    <Path
      ...
      stroke="url(#paint0_linear_1287_2623)"
      strokeWidth="3.42118"
      strokeLinecap="round"
...
export default function BackToStoreScreen() {
  ...
  const handleSelectGoogleMap = () => {
    setShowNavigationModal(false);
    console.log("Google Map selected");
  };

  const handleSelectInAppMap = () => {
    setShowNavigationModal(false);
    console.log("In-App Map selected");
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.mapContainer}>
        ...
        >
          ...
          <View style={styles.originLabel}>
            <Text style={styles.originLabelText}>Bellaire Town</Text>
          </View>
      ...
      <NavigationMapModal
        ...
        onSelectGoogleMap={handleSelectGoogleMap}
        onSelectInAppMap={handleSelectInAppMap}
      />
    </View>
  );
}
