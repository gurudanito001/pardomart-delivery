...
export default function OrdersScreen() {
  ...
  const handlePreviewOrder = (orderId: string) => {
    router.push({ pathname: '/(tabs)/orders/shopping-list', params: { orderId } });
  };
        ...
        <View style={styles.pageHeader}>
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerActions}>
              <TouchableOpacity style={styles.headerAction} onPress={handleOpenNotifications}>
                <Ionicons name="notifications-outline" size={22} color="#FFFFFF" />
              </TouchableOpacity>
              <TouchableOpacity style={styles.headerAction} onPress={handleSupport}>
          ...
          <View style={styles.banner}>
            ...
            <View style={styles.bannerDetails}>
              ...
              <Text style={styles.bannerSubtitle}>Three customers are waiting for confirmation.</Text>
            </View>
          </View>
        </View>
          ...
          {ORDER_REQUESTS.map((order) => (
            <View key={order.id} style={styles.orderCard}>
              ...
              <View style={styles.cardFooter}>
                <Text style={styles.cardHint}>Track progress and manage substitutions from here.</Text>
                <TouchableOpacity
